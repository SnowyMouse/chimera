...
namespace Chimera {
    ...
    static void on_frame() noexcept {
        ...
        else SET_KEY_IF_HELD(num_0, "0")
        else SET_KEY_IF_HELD(num_1, "1")
        else SET_KEY_IF_HELD(num_2, "2")
        else SET_KEY_IF_HELD(num_3, "3")
        else SET_KEY_IF_HELD(num_4, "4")
        else SET_KEY_IF_HELD(num_5, "5")
        else SET_KEY_IF_HELD(num_6, "6")
        else SET_KEY_IF_HELD(num_7, "7")
        else SET_KEY_IF_HELD(num_8, "8")
        else SET_KEY_IF_HELD(num_9, "9")
