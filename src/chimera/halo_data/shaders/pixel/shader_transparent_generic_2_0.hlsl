...
half4 main_T0_P0(PSInput i) : COLOR {
...
half4 main_T0_P1(PSInput i) : COLOR {
    #ifdef FIRST_MAP_IS_CUBE
    float4 t0 = texCUBE(TS0, i.T0);
    #else
    float4 t0 = tex2Dproj(TS0, i.T0);
    ...
    #ifdef S0_CONFIGURATION
    STAGE_FOGGED(S0_CONFIGURATION)
    #endif

    #ifdef S1_CONFIGURATION
    STAGE_FOGGED(S1_CONFIGURATION)
    #endif

    #ifdef S2_CONFIGURATION
    STAGE_FOGGED(S2_CONFIGURATION)
    #endif

    #ifdef S3_CONFIGURATION
    STAGE_FOGGED(S3_CONFIGURATION)
    #endif

    #ifdef S4_CONFIGURATION
    STAGE_FOGGED(S4_CONFIGURATION)
    #endif

    #ifdef S5_CONFIGURATION
    STAGE_FOGGED(S5_CONFIGURATION)
    #endif

    #ifdef S6_CONFIGURATION
    STAGE_FOGGED(S6_CONFIGURATION)
    #endif

    #ifdef S7_CONFIGURATION
    STAGE_FOGGED(S7_CONFIGURATION)
    #endif

    return r0;
};

half4 main_T0_P2(PSInput i) : COLOR {
    #ifdef FIRST_MAP_IS_CUBE
    float4 t0 = texCUBE(TS0, i.T0);
    #else
    float4 t0 = tex2Dproj(TS0, i.T0);
    ...
    #ifdef S0_CONFIGURATION
    STAGE_NOFOG(S0_CONFIGURATION)
    #endif

    #ifdef S1_CONFIGURATION
    STAGE_NOFOG(S1_CONFIGURATION)
    #endif

    #ifdef S2_CONFIGURATION
    STAGE_NOFOG(S2_CONFIGURATION)
    #endif

    #ifdef S3_CONFIGURATION
    STAGE_NOFOG(S3_CONFIGURATION)
    #endif

    #ifdef S4_CONFIGURATION
    STAGE_NOFOG(S4_CONFIGURATION)
    #endif

    #ifdef S5_CONFIGURATION
    STAGE_NOFOG(S5_CONFIGURATION)
    #endif

    #ifdef S6_CONFIGURATION
    STAGE_NOFOG(S6_CONFIGURATION)
    #endif

    #ifdef S7_CONFIGURATION
    STAGE_NOFOG(S7_CONFIGURATION)
    #endif
