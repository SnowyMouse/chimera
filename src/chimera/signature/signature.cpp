...
namespace Chimera {
    ...
    std::vector<Signature> find_all_signatures() {
        ...
        FIND("spectate_control_sig", "client_spectate", {0x0F, 0xBF, 0xC1, 0x8B, 0x44, 0x82, 0x04, 0xEB, 0x03, 0x83, 0xC8, 0xFF, 0x33, 0xD2, 0x83, 0xF8, 0xFF, 0x8B, 0xF5, 0x89, 0x16});
        FIND("spectate_armor_color_sig", "client_spectate", { 0x8B, 0x44, 0x81, 0x04, 0x83, 0xF8, 0xFF, 0x0F, 0x84, -1, -1, -1, -1, 0x8B, 0x15, -1, -1, -1, -1, 0x8B, 0x4A, 0x34, 0x25, 0xFF, 0xFF, 0x00, 0x00 });
        FIND("spectate_motion_sensor_sig", "client_spectate", { 0x8B, 0x44, 0x90, 0x04, 0x83, 0xF8, 0xFF, 0x75, 0x09, 0x83, 0xC9, 0xFF });
        ...
        FIND("spectate_fp_weapon_sig", "client_spectate", { 0x8B, 0x40, 0x04, 0x83, 0xF8, 0xFF, 0x74, -1, 0x8B, 0x15 });
        ...
        FIND("spectate_reticle_team_sig", "client_spectate", { 0x0F, 0xBF, 0xD6, 0x8B, 0x44, 0x90, 0x04, 0xEB, 0x03, 0x83, 0xC8, 0xFF, 0x8B, 0x0D, -1, -1, -1, -1, 0x8B, 0x51, 0x34, 0x25, 0xFF, 0xFF, 0x00, 0x00, 0xC1, 0xE0, 0x09, 0x03, 0xC2, 0x55 });
