...
namespace Chimera {
    ...
    std::vector<Signature> find_all_signatures() {
        ...
        FIND("get_crc_sig", "core_fast_load", { 0xC1, 0xE0, 0x04, 0x8B, 0x4C, 0x10, 0x0C, 0x51, 0x89, 0x8C, 0x24 });
        ...
        FIND("map_index_sig", "core_fast_load", { 0x8B, 0x15, -1, -1, -1, -1, 0x5F, 0xC1, 0xE1, 0x04, 0x5E }); // TODO: switch to using 3B05????????7D??8B0D for map count; map indices pointer are adjacent to this value
        FIND("load_multiplayer_maps_sig", "core_fast_load", {0x81, 0xEC, 0x40, 0x01, 0x00, 0x00, 0x56, 0xBE, -1, -1, -1, -1, 0x8D, 0x64, 0x24, 0x00, 0x8B, 0x46, 0xFC, 0x50});
