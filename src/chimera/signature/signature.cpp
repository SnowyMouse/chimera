...
namespace Chimera {
    ...
    std::vector<Signature> find_all_signatures() {
        ...
        FIND("map_check_demo_sig", "core_demo", { 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x53, 0x57, 0x50, 0x68 });
        ...
        FIND("ce_check_load_sig", "core_memory", {0x81, 0x3D, -1, -1, -1, -1, 0x61, 0x02, 0x00, 0x00, 0x0F, 0x85, -1, 0x04, 0x00, 0x00});
        FIND("ce_check_startup_sig", "core_memory", {0x81, 0x3D, -1, -1, -1, -1, 0x61, 0x02, 0x00, 0x00, 0x0F, 0x85, -1, 0x01, 0x00, 0x00});
        FIND("ce_check_preload_map_list_sig", "core_memory", {0x81, 0x7E, 0x04, 0x61, 0x02, 0x00, 0x00, 0x75, 0x02});
        FIND("ce_check_loading_sig", "core_memory", { 0x81, 0x7F, 0x04, 0x61, 0x02, 0x00, 0x00, 0x74, 0x7A, 0x33, 0xC0 });
        FIND("after_memory_allocated_sig", "core_memory", { 0xFF, 0x15, -1, -1, -1, -1, 0x5F, 0x5E, 0x8B, 0xE5, 0x5D, 0xC3 });
        FIND("read_file_ex_map_sig", "core_memory", { 0xFF, 0x54, 0x24, 0x1C, 0x85, 0xC0, 0x75, 0x29 });
        FIND("loaded_header_sig", "core_memory", { 0x0F, 0xBF, 0x05, -1, -1, -1, -1, 0x69, 0xC0, 0x0C, 0x08, 0x00, 0x00, 0x8B, 0x88, -1, -1, -1, -1, 0x8A, 0x46, 0x20, 0x84, 0xC0, 0x74, 0x24 });
        FIND("map_path_3_sig", "core_memory", { 0x68, -1, -1, -1, -1, 0x52, 0xE8, -1, -1, -1, -1, 0x83, 0xC4, 0x14, 0x8D, 0x44, 0x24, 0x10, 0x53, 0x50 });
